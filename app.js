...
function takeCommand(message) {
    if (message.includes('hey') || message.includes('hello')) {
        ...
        speak("I'm virtual assistant ,Created by Anusha Khan");
    }
        ...
        window.open('https://anushakhan49.github.io/Calculator_Responsive/')
        ...
        let finalText = "here's the results about" + message.replace("jacquelie"||"jacklie"||"jacklin"||"search on youtube" , "")

        speak(finalText)
        window.open(`https://www.youtube.com/search?q=${message.replace("search on youtube", "")}`, "_blank")
    }
    else {
